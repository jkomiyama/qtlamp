...
fname_ext="${1##*/}"
fname="${fname_ext%.*}"
python script/bootstrapping.py -f $1 -s -o temp/$fname.$4.split -n $3
echo "data generated."
...
python script/bootstrapping.py -v -f out/$fname-$4.bh.out -a out/$fname-result-$2-$3-$4-txt --wr $2
python script/bootstrapping.py -v -f out/$fname-$4.ep.out -a out/$fname-result-$2-$3-$4-txt --wr $2
